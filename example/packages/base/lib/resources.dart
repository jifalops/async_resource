...
abstract class Resources {
  Resources({@required this.posts, @required this.darkBackground})
      : streamedPosts = StreamedResource(posts);
  ...
  /// Wraps [posts] to provide a stream and sink. Both are used here for the
  /// purpose of showing an example.
  final StreamedResource<Iterable<Post>> streamedPosts;
}
